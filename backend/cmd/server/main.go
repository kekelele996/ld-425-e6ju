...
func seedDemoData(
	...
	materials := []struct {
		...
		{"实木地板", "地板", "1210x165", "大自然", "卧室", 42, 259, constants.PurchaseStatusOrdered},
		{"乳胶漆", "油漆", "5L", "多乐士", "客厅", 12, 328, constants.PurchaseStatusNotPurchased},
		{"LED筒灯", "灯具", "7W", "欧普", "厨房", 18, 59, constants.PurchaseStatusDelivered},
	}
	for _, item := range materials {
		...
		// 初始采购状态为 NotPurchased，允许向前推进到到货/已安装等状态。
		if item.status != constants.PurchaseStatusNotPurchased {
